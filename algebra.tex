...
\begin{titlepage}
	...
	{\large ſporządzone dla ſtudentów kierunku Informatyka y Syſtemy Informacyine,
		ſpecyalność Proiektowanie Syſtemów CAD \& CAM na Politechnice Wárßáwſkiey,
	...
	\begin{pspicture}(-1.5,-1.0)(1.5,0.0)%
		\rput[t](0,-0.5){\psvectorian[width=7.5cm]{88}}
	\end{pspicture}%
	\vspace{0.5cm}
	\\
	{\LARGE \red MM XX V.}
...
\begin{definition}
	\textbf{Jądrem} homomorfizmu $h: A \to B$ nazywamy relację określoną wzrorem
	\begin{equation}
...
\begin{proof}
	...
	Niech $f^n \in \Sigma$ będzie dowolnym symbolem arności $n$,
		a $f_A$ odpowiadającą mu funkcją na $A$.
	Weźmy dowolne
	\begin{equation}
		x_1 \dots, x_n,\;y_1, \dots, y_n \in A
	\end{equation}
	...
	czyli
	\begin{equation}
		f_A(h(x_1), \dots, h(x_n)) = f_A(h(y_1), \dots, h(y_n)),
	\end{equation}
