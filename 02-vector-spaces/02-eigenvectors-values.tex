...
W tej sekcji zakładamy,
	...
	które jest równe $\mathbb{R}$ lub $\mathbb{C}$.

\begin{definition}
	\textit{Wektorem własnym} macierzy $A \in \mathbb{K}^{n \times n}$
		nazywamy niezerowy wektor $v \in \mathbb{K}^{n \times 1}$ taki,
...
\begin{definition}
	Macierz $A \in \mathbb{K}^{n \times n}$ nazywamy \textit{diagonalizowalną},
